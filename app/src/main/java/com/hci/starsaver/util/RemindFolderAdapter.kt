...
class RemindFolderAdapter: ListAdapter<BookMark, RemindFolderAdapter.ViewHolder>(diffUtil) {
    ...
    inner class ViewHolder(private val binding: ItemRemindFolderBinding): RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(ItemRemindFolderBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
